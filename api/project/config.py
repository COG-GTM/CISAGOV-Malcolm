...
class Config(object):
    ...
    FILESCAN_HOST = os.getenv('FILESCAN_HOST', 'filescan')
    FILESCAN_HEALTH_PORT = int(os.getenv('FILESCAN_HEALTH_PORT', '8001'))
    FILESCAN_HTTP_SERVER_PORT = int(os.getenv('FILESCAN_HTTP_SERVER_PORT', '8006'))
    ...
    VALKEY_CACHE_HOST = os.getenv('VALKEY_CACHE_HOST', 'valkey')
    VALKEY_CACHE_PORT = int(os.getenv('VALKEY_CACHE_PORT', '6379'))
    ...
    STRELKA_HOST = os.getenv('STRELKA_HOST', 'strelka-frontend')
    STRELKA_PORT = int(os.getenv('STRELKA_PORT', '57314'))
